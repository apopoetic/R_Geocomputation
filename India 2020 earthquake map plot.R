...
#load earthquake data (from https://www.indiastat.com/table/meteorological-data/month-wise-earthquakes-detected-located-seismologi/1382679)
eq_ <- read_csv("data.csv", na = c("", NA))
#remove rows with NA
eq <- eq_ %>% drop_na()
